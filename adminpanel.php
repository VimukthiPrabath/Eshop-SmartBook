...
?>
    ...
    <head>
        ...
        <title>Admin Panel | Smartbook</title>
    ...
    <body style="background-color: #74EBD5;background-image: linear-gradient(90deg,#74EBD5 0%,#9FACE6 100%);" class="bodyall1">
                    ...
                    <div class="row">
                        <div class="col-12 align-items-start vh-100">
                            <div class="row g-1 text-center">
                                ...
                                <div class="col-12 mt-5">
                                    <hr class="border border-1 border-white" />
                                    <a href="sellingHistory.php" class="text-white fw-bold">Selling History</a>
                                    <hr class="border border-1 border-white" />
                                </div>
                    ...
                    <div class="row">
                                ...
                                <div class="col-6 col-lg-4 px-1 shadow">
                                    <div class="row g-1">
                                        <div class="col-12 bg-primary text-white text-center rounded" style="height: 100px;">
                                            ...
                                            ?>
                                            <span class="fs-5">Rs. 700 .00</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-lg-4 px-1">
                                    <div class="row g-1">
                                        <div class="col-12 bg-warning text-black text-center rounded" style="height: 100px;">
                                            ...
                                            <span class="fs-5">Rs. 3500 .00</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-lg-4 px-1">
                                    <div class="row g-1">
                                        <div class="col-12 bg-primary text-white text-center rounded" style="height: 100px;">
                                            ...
                                            <br />
                                            <span class="fs-5"><?php echo $c; ?>1 Items</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 ">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-10 text-center my-3">
                                    ...
                                    ?>
                                    <label class="form-label fs-4 fw-bold text-warning" id="countingTime">
                                        <?php
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                FROM `invoice` WHERE `date` LIKE '%" . "%' GROUP BY `product_id` ORDER BY 
                                ...
                                if ($freq_num > 0) {
                                    ...
                                    `product_id`='" . $freq_data["product_id"] . "' AND `date` LIKE '%" . "%'");
                                ...
                                ?>
                                    <div class="col-12 text-center shadow">
                                        <img src="resource/books/HUMAN HISTOLOGY.jpg" class="img-fluid rounded-top" style="height: 250px;" />
                                    </div>
                                    <div class="col-12 text-center my-3">
                                        <span class="fs-5 fw-bold">HUMAN HISTOLOGY</span><br />
                                        <span class="fs-6"> 1 items</span><br />
                                        <span class="fs-6">Rs. 1200 .00</span>
                                    </div>
                                <?php
                                }
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center shadow">
                                        <img src="resource/users.png" class="img-fluid rounded-top" style="height: 250px;" />
                                    </div>
                                    <div class="col-12 text-center my-3">
                                        <span class="fs-5 fw-bold">Vimukthi Prabath</span><br />
                                        <span class="fs-6">Vimukthivpk123@gmail.com</span><br />
                                        <span class="fs-6">0716691190</span>
                                    </div>
                                <?php
                                }
