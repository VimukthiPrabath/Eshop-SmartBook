...
<div class="row">
    <div class="offset-lg-1 col-12 col-lg-10 text-center">
        <div class="row">
            ...
            ?>
                <div class="card mt-2 mb-2 col-lg-3" style="width: 18rem;">
                    <?php
                    ...
                    <img src="<?php echo $image_data["code"]; ?>" class="card-img-top img-thumbnail mt-2" style="height: 200px" />
                    <div class="card-body ms-0 m-0">
                        <h5 class="card-title"><?php echo $selected_data["title"]; ?> <span class="badge bg-info">New</span></h5>
                        <span class="card-text text-primary"><?php echo $selected_data["price"]; ?></span><br />
                        ...
                        <button class="col-12 btn btn-outline-secondry mt-2"><i class="bi bi-heart-fill text-danger fs-5"></i></i></button>
                    </div>
                </div>
            <?php
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination pagination-lg justify-content-center">
            ...
            ?>
                    ...
                    <li class="page-item active"><a class="page-link" href="<?php echo "?page=" . ($x); ?>"><?php echo $x; ?></a></li>
