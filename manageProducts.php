...
<head>
    ...
    <title>Manage Products | Admins | Smartbook</title>
    ...
    <div class="container-fluid bodyall1">
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    <div class="col-1 col-lg-1 bg-primary py-2 text-end mx-2">
                        <span class="fs-4 fw-bold text-white">#</span>
                    </div>
                    <div class="col-2 d-none d-lg-block bg-light py-2 mx-2">
                        <span class="fs-4 fw-bold">Product Image</span>
                    </div>
                    <div class="col-4 col-lg-2 bg-primary py-2 mx-2">
                        <span class="fs-4 fw-bold text-white">Title</span>
                    </div>
                    <div class="col-4 col-lg-2 d-lg-block bg-light py-2 mx-2">
                        <span class="fs-4 fw-bold">Price</span>
                    </div>
                    <div class="col-1 d-none d-lg-block bg-primary py-2 mx-2">
            ...
            ?>
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2 mx-2" onclick="viewProductModal('<?php echo $selected_data['id']; ?>');">
                            <?php
                            $image_rs = Database::search("SELECT * FROM `image` WHERE `product_id`='" . $selected_data["id"] . "'");
                            $image_num = $image_rs->num_rows;
                            if ($image_num == 0) {
                            ?>
                                <img src="resource/mobile_image/iphone12.jpg" style="height: 40px;margin-left: 80px;" />
                            <?php
                            } else {
                        ...
                        <div class="col-2 col-lg-1 bg-white py-2 d-grid mx-2">
                            <?php
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-12">
                                    <span class="fs-5 fw-bold text-danger">Price :</span>&nbsp;
                                    <span class="fs-5 text-info">Rs.<?php echo $selected_data["price"]; ?>.00</span><br />
                                    <span class="fs-5 fw-bold text-danger">Quantity :</span>&nbsp;
                                    <span class="fs-5 text-info"><?php echo $selected_data["qty"]; ?> Products left</span><br />
                                    <span class="fs-5 fw-bold text-danger">Seller :</span>&nbsp;
                                    <span class="fs-5 text-info">vimukthi</span><br />
                                    <span class="fs-5 fw-bold text-danger ">Description :</span>&nbsp;
                                    <span class="fs-5 text-info"><?php echo $selected_data["description"]; ?></span><br />
                                </div>
                            </div>
